...
import GuestInfoForm from "../features/guests/GuestInfoForm";
...
const Icon1 = styled.div`
  ...
  ${Button}:hover & {
    animation: ${slay_1} 3s cubic-bezier(0.52, 0, 0.58, 1) infinite;
    transform: rotate(10deg);
  }
`;
const Icon2 = styled.div`
  ...
  ${Button}:hover & {
    animation: ${slay_2} 3s cubic-bezier(0.52, 0, 0.58, 1) infinite;
    transform: rotate(10deg);
  }
`;
const Icon3 = styled.div`
  ...
  filter: drop-shadow(2px 2px 3px rgba(0, 0, 0, 0.5));
  ${Button}:hover & {
    animation: ${slay_3} 3s cubic-bezier(0.52, 0, 0.58, 1) infinite;
    transform: rotate(10deg);
  }
`;
function BtnGarden({ children }) {
  const { numNights, numGuests } = useBookingInfo();
  const disable = numNights <= 0 || numGuests < 1;
  return (
    <Modal>
